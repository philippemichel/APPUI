...
fviz_screeplot(rtt, addlabels = TRUE, ylim = c(0, 20), title = "Variance par axe")
```

La variance expliquée par les deux premiers axes n'est que de `r round(rtt$eig[2,3], 1)` %. Les résultats suivants sont donc à prendre avec précaution. L'analyse des axes 3 & 4 n'a pas montré de résultats pertinents.

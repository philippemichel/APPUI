---
title: "Rapport statistique V1.0"
cache: false
---
...
zz <- tt |> 
  dplyr::select(-c(id, fc, grossesse,traitement_propose,specialite,germe_identifie,microbio_dispo,exam_comp,germe,microbio_sortie)) |> 
  dplyr::select(!starts_with("si_")) |> 
...
Une classification non supervisée ne donne pas de résultat intéressant.
